...
<div class="text-end me-4">
    <a class='btn btn-success btn-sm' href='Instructor View.php'>View</a>
</div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM payment_history ORDER BY user_name";
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class='btn btn-primary btn-sm' href='Create Instructions.php?id=$row[id]'>Instruct</a>
                        </td>
                    </tr>
                    ";
                    $rowNumber++;
